...
#define		STAGE_SFIGHT_AREA		100		// Top Fight Area
#define		ADSENSE_HEIGHT_SINGLE	60		// Google Ads 468 * 60
#define		ADSENSE_HEIGHT_MULTI	90		// Google Ads 728 * 90
...
BOOL			bAdsence = TRUE;					// Google Adsense 
RECT			rtWindow;							// Window Size
