// DoSys.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CDoSysApp, CWinApp)
	//{{AFX_MSG_MAP(CDoSysApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CDoSysApp object

CDoSysApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CDoSysApp initialization

BOOL CDoSysApp::InitInstance()
{
	...
	static const char szProgName[] = "DoSysSystemManager";
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDoSysDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CDoSysView));
	...
	m_pMainWnd->ShowWindow(SW_HIDE);	// Start Hide
...
//	SetWindowPos(m_pMainWnd->GetSafeHwnd(), HWND_TOPMOST, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE);
	...
	{
		LONG ret = RegQueryValueEx(hkey, "DoSys SystemManager", 0, 0, (LPBYTE )lbData, (LPDWORD)&datasize);
...
/////////////////////////////////////////////////////////////////////////////
// CDoSysApp message handlers
BOOL CDoSysApp::PreTranslateMessage(MSG* pMsg)
{
...
void CDoSysApp::OnUpdateViewTop(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->SetCheck(m_bCheck);
}

void CDoSysApp::OnAppAuto() 
{
	// TODO: Add your command handler code here
	m_bAuto = 1 - m_bAuto;
	if(m_bAuto == 0)
	{
		...
		if (retval == ERROR_SUCCESS) 
			::RegDeleteValue(hkey, "DoSys SystemManager");
		RegCloseKey(hkey);
	}
	else
	{
		...
		if (retval == ERROR_SUCCESS) 
			RegSetValueEx(hkey, "DoSys SystemManager", 0, REG_SZ, (LPBYTE )szTemp, strlen(szTemp));
		RegCloseKey(hkey);
	}
}

void CDoSysApp::OnUpdateAppAuto(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
