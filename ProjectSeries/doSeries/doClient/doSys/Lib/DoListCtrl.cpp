...
void CDoListCtrl::Resize(int cx, int cy, int ntype)
{
	...
	{
		case 0:			// System List
			SetColumnWidth(0, (nWidth*30)/100);
			SetColumnWidth(1, (nWidth*69)/100);
			break;
		case 1:			// Network List
			SetColumnWidth(0, (nWidth*40)/100);
			SetColumnWidth(1, (nWidth*59)/100);
			break;
		case 2:			// Packet List
			SetColumnWidth(0, (nWidth*50)/100);
			SetColumnWidth(1, (nWidth*49)/100);
			break;
		case 3:			// Install List
			SetColumnWidth(0, (nWidth*60)/100);
			SetColumnWidth(1, (nWidth*20)/100);
			SetColumnWidth(2, (nWidth*17)/100);
			break;
		case 4:			// Service List
			SetColumnWidth(0, (nWidth*30)/100);
			SetColumnWidth(1, (nWidth*30)/100);
			SetColumnWidth(2, (nWidth*20)/100);
			SetColumnWidth(3, (nWidth*9)/100);
			SetColumnWidth(4, (nWidth*8)/100);
			break;
		case 5:			// Regist List
			SetColumnWidth(0, (nWidth*20)/100);
			SetColumnWidth(1, (nWidth*20)/100);
			SetColumnWidth(2, (nWidth*59)/100);
			break;
	}
}
