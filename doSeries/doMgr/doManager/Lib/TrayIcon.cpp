...
LRESULT CALLBACK CTrayIcon::WndProc(HWND hWnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	static UINT s_uTaskbarRestart;
	OutputDebugString("Tray Icon ReDraw OK");
	AfxMessageBox("Tray Icon ReDraw OK");
